            ...
            <div className={customStyles.container}>
              ...
              <div className={customStyles.banner}>
                <div className={customStyles.bannerHeader}>
                  ...
                  <motion.div
                    className="absolute bg-primary3 inset-5 blur-[60px] -z-10"
                    initial={{ scale: 0.8, opacity: 0 }}
                    animate={{ scale: 1, opacity: 1 }}
                    transition={{ duration: 2, delay: 0.5, ease: "backInOut" }}
                  ></motion.div>
                  <motion.div
                    className="absolute inset-0 bg-primary3 blur-[80px] scale-y-75 scale-x-125 rounded-full -z-10"
        ...
        <Route
          ...
          element={
            <ChapterQuiz
              ...
              questions={investingPracticeQuiz}
              isBasic={false}
            />
          }
        />
