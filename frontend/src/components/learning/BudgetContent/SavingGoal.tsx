...
import { savingGoalsContent } from "@/data/budgeting/savingGoals"; 
    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={
<ExpandableCard
        title={savingGoalsContent.title}
        description={savingGoalsContent.description}
        content={savingGoalsContent}
