...
import { expenseTrackingContent } from "@/data/budgeting/expense"; 
    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={
<ExpandableCard
        title={expenseTrackingContent.title}
        description={expenseTrackingContent.description}
        content={expenseTrackingContent}
